...
export default applySpec({
  ...
  partner_birthday: pipe(prop('birthDate'), getTimestampFromBirthDate),
  partner_mother_name: prop('montherName'),
  partner_phone: pipe(prop('phone'), formatPhoneNumber),
  ...
  mql: buildMql,
  primary_phone: pipe(prop('commercialPhone'), formatPhoneNumber),
})
